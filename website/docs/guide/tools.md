...
An applet of `magisk`. An advanced system property manipulation utility. Check the [Resetprop Details](/guide/details#resetprop) for more background information.
